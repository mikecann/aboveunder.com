      ...
      <Container>
        {props.showLogo == true || props.showLogo === undefined ? (
          <Menu.Item header href="/" style={{ padding: "0.4em" }}>
            <Image
              alt="square logo"
              src="/images/Above-Under-Square-Logo-150x150.png"
              height={60}
            />
          </Menu.Item>
        ) : null}
          ...
          <Dropdown.Menu>
            {menuItems.map(o => (
              <Dropdown.Item
                ...
                as={Link}
                to={o.url}
                style={{ borderBottom: "1px solid rgb(222, 222, 222)", width: 160 }}
              >
                {" "}
                {o.label}
              </Dropdown.Item>
  ...
  return (
    <Menu {...props.menuProps}>
      <Container>
        {props.showLogo == true || props.showLogo === undefined ? (
          <Menu.Item header href="/" style={{ padding: "0.4em" }}>
            <Image alt="header logo" src="/images/header-logo.png" height={60} />
          </Menu.Item>
        ) : null}

        {menuItems.map(o => (
          <Menu.Item key={o.id} as={Link} active={props.activeMenu == o.id} to={o.url}>
            {o.label}
          </Menu.Item>
        ))}
