        ...
        <Grid.Row>
          ...
          <Grid.Column width={2}>
            ...
            <List link inverted>
              ...
              <List.Item as="a" href="/videos">
                Videos
              </List.Item>
              <List.Item as="a" href="/map">
                Map
              </List.Item>
            </List>
          </Grid.Column>
          ...
          <Grid.Column width={7}>
            ...
            <a href="//twitter.com/aboveunder_">
              <Icon inverted name="twitter" />
            </a>
            <a href="//instagram.com/aboveunder_">
              <Icon inverted name="instagram" />
            </a>
            <a href="//facebook.com/aboveunder">
              <Icon inverted name="facebook" />
            </a>
            <a href="mailto:mike@aboveunder.com">
